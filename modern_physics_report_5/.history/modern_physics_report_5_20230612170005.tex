...
\subsection*{실험1. 전자의 회절}
	...
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=5cm]{Figures/experimental_exam.png}
		\caption{}
	...
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=5cm]{Figures/experimental_exam2.png}
		\caption{}
...
\subsection*{실험2. XRD}
	...
	\begin{enumerate}[label=\arabic*.]
		...
		-	결정립 LiF, KBr을 측정할 것이다.
		-	1:2 coupling mode, Gate time 2 s; angle step width 0.1 degree로 한다.
		-	Scanning range from 4 to 55 degree (LiF), and from 3 to 75 degree (KBr).
		-	Anode voltage 35 kV; anode current 1 mA.
		-	양자화되어 있는 에너지 준위를 계산한다.

...
# Figure
fig, ax = plt.subplots()
plt.plot(X, Y1, label='$U = D_1$', color='k', marker='o', markersize=5, linestyle='solid', linewidth=1)
plt.plot(X, Y2, label='$U = D_2$', color='k', marker='s', markersize=5, linestyle='solid', linewidth=1)
...
plt.plot(X, Y2, ls='solid', label='$U = D_2$')
plt.plot(X, Y1, ls='solid', label='$U = D_1$')

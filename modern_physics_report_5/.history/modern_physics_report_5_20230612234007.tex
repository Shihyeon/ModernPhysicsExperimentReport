...
\begin{minted}[breaklines=true, mathescape, linenos]{python}[frame=lines,	framesep=2mm,	baselinestretch=1.2,	bgcolor=LightGray,	fontsize=\footnotesize,	linenos]	{python}

...
# Data1
data1 = genfromtxt('data1.csv', delimiter=',', encoding='UTF8')
...
# Data2
data2 = genfromtxt('data2.csv', delimiter=',', encoding='UTF8')
## from row=3 to infty, column=0에 대해 low=0을 출력
X2 = data1[3:, 0]
## from row=3 to infty, column=1에 대해 low=1을 출력
Y2 = data1[3:, 1]
...
# Figure
fig, ax = plt.subplots()
plt.plot(X1, Y1, color='k', linestyle='solid', linewidth=1)
plt.plot(X2, Y1, color='k', linestyle='solid', linewidth=1)

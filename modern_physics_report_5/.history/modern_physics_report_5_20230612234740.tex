...
%----------------------------------------------------------------------------------------
%	SOURCE CODE FORPHTHON FITTING fitting
%----------------------------------------------------------------------------------------
...
\begin{minted}[breaklines=true, mathescape, frame=lines,	framesep=2mm,	baselinestretch=1.2,	bgcolor=LightGray,	fontsize=8pt,	linenos]{python} 

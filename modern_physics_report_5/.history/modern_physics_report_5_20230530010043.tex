...
\section{Result and Discussion}
	...
	2 nm로 측정했을 때, 분자 사이즈의 10배 정도의 size로 측정되기에 한 line에 10개 정도의 분자가 보일 것이다. HOPG는 Graphite이기에 육각형 튜브 구조이다. 측정이 잘 되었다면 육각형의 원자 구조를 볼 수 있었겠으나, tip이 잘 만들어지지 않아 노이즈가 생겨 Figures~5와 같이 육각 

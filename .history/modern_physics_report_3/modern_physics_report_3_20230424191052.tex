...
\begin{enumerate}[label=\arabic*.]
	...
	\begin{figure}
		\subfloat[Row1]{{\includegraphics[width=0.5\textwidth ]{Fig02-0.eps} }}
		\subfloat[Row2]{{\includegraphics[width=0.5\textwidth ]{Fig02-1.eps} }}
		\hfill
		\subfloat[Row3]{{\includegraphics[width=0.5\textwidth ]{Fig02-2.eps} }}%
		\subfloat[Row4]{{\includegraphics[width=0.5\textwidth ]{Fig02-3.eps} }}%
		\caption{Representative waveforms of anode and cathide signals measured at (a) 100, (b) 400, (c) 800, and 1200 V. The cathode signal is used to evaluate the starting time of an electron cloud as it drifts towards the anode.}%

...
\begin{enumerate}[label=\arabic*.]
	...
	\begin{figure}[h]
		\centering
		\begin{subfigure}{width=5cm}%각 subfigure은 하나의 
			\includegraphics[width=5cm]{C:/LaTeXPic/RedSquare}
			\caption{빨간 네모}
			\label{RS}
		\end{subfigure}
		\begin{subfigure}{width=5cm}
			\includegraphics[width=5cm]{C:/LaTeXPic/BlueSquare}
			\caption{파란 네모}
			\label{BS}
		\end{subfigure}

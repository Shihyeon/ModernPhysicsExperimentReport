...
\begin{enumerate}[label=\arabic*.]
	...
	\begin{figure*}[!t]
		\centering
		\subfigure[]{
		\includegraphics[width=.9\columnwidth]{figure/predErrorWithDifferentGroups_2}
		\label{fig:nrGroup}
		}
		
		\subfigure[]{
		
		\includegraphics[width=.9\columnwidth]{figure/figOverall_2}
		...
		(a) Average reconstruction error as a function of the number of groups.
		
		(b) Average reconstruction errors of ten scenarios.

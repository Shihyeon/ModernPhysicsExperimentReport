...
\begin{enumerate}[label=\arabic*.]
	...
	\begin{figure}
		...
		\subfloat[Row2]{{\includegraphics[width=0.5\textwidth ]{fig3.jpg} }}
	\hfill
		\subfloat[Row3]{{\includegraphics[width=0.5\textwidth ]{fig4.jpg} }}
		\subfloat[Row4]{{\includegraphics[width=0.5\textwidth ]{fig5.jpg} }}

...
\section{결론}
	...
	Franck-Hertz experiment with neon에서 네온 원자에 속박된 전자가 양자화되어 있음을 확인할 수 있었다. 특히 Fig. 6을 보면 특정 peak에서 전류가 상승하는 것을 볼 수 있고, 이는 전하가 이동함을 뜻한다. 즉, 그 순간에 속박에서 풀려난다는 것을 알 수 있다. 또한, Fig. 7을 통해 orbit을 건너 뛸 때마다 

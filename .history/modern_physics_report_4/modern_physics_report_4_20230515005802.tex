...
\subsubsection{Franck-Hertz curve:}
	...
	The distance between the vertical lines (these were placed by eye on the main points of the maxima) has an average value of DU2 = 18.5 V. This value is much closer to the excitation energies for the 3p-levels of neon (18.4 – 19.0 eV) than to the energies of the 
3s-levels (16.6 – 16.9 eV). Thus, the probability of excitation to the latter due to inelastic 
electron collision is significantly less. The substructure in the measured curve shows that 
the excitation of the 3s-levels cannot be ignored altogether. Note that for double and 
multiple collisions, each combination of excitation of a 3s-level and a 3p-level occurs. 
